      ...
      <div className=" flex">
        ...
        <div className=" bg-cyan-300 w-[350px]">
          <div className=" text-center">
            ...
            <div>
              <button className=" mr-2 mt-4 border-solid border-2 w-32 p-2 border-indigo-600">
                ALL
              </button>
              <button className="ml-2 mt-4 border-solid border-2 w-32 p-2 border-indigo-600">
                New
              </button>
            </div>
          </div>
